...
{
    [JsonIgnore] public override string Name { get; set; } = "OSC";
    ...
    [JsonIgnore] public override SettingType SettingType { get; set; } = SettingType.OSC;

    public string Host { get; set; } = "127.0.0.1";

    [Range(1, 65535)] public int TCPPort { get; set; } = 9000;

    [Range(1, 65535)] public int UDPPort { get; set; } = 9001;
}