...
namespace dOSCEngine.Services.User
{
    public class dOSCSetting : SettingBase
    {
        ...
        [Required]
        [Range(1, 65535)]
        public int HubServerPort { get; set; } = 5002;
        ...
        public Uri GetHubServerUri(string ApiKey)
        {
            return new Uri($"ws://localhost:{GetHubServerPort()}/ws?apiKey={ApiKey}");
        }
    }
}
