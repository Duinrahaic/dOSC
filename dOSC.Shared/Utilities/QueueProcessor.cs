...
public class QueueProcessor<T> : IDisposable
{
    ...
    private readonly ConcurrentQueue<(T Item, Func<T, Task> ProcessFunc, Action<T> Callback)> itemQueue = new();
        ...
        bool isSequential = false)
    {
        ...
        processItemAsync = customProcessItemAsync ?? DefaultProcessItemAsync;

        // Use the provided custom callback logic, or use a default implementation
        processItemCallback = customProcessItemCallback ?? DefaultProcessItemCallback;
