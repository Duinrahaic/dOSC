...
namespace dOSCEngine.Engine.Nodes.Connectors.VRChat
{
    ...
    {
        public OSCVRCChatboxNode(ServiceBundle? service = null, Point? position = null) : base(position ?? new Point(0, 0))
        {
        ...
        public OSCVRCChatboxNode(Guid guid, ServiceBundle? service = null, Point? position = null) : base(guid, position ?? new Point(0, 0))
        {
            AddPort(new LogicPort(PortGuids.Port_1, this, true)); // Send
            AddPort(new StringPort(PortGuids.Port_2, this, true)); // Message 
            AddPort(new LogicPort(PortGuids.Port_3, this, true)); // Immediately?
