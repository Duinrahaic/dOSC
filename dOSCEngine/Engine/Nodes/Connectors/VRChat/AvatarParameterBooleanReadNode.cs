...
namespace dOSCEngine.Engine.Nodes.Connectors.VRChat
{
    ...
    {
        public AvatarParameterBooleanReadNode(ServiceBundle? service = null, Point? position = null) : base(position ?? new Point(0, 0))
        {
        ...
        public AvatarParameterBooleanReadNode(string? SelectedOption, ServiceBundle? service = null, Point? position = null) : base(position ?? new Point(0, 0))
        {
            AddPort(new LogicPort(PortGuids.Port_1, this, false));
            _service = service?.OSC;
        ...
        public AvatarParameterBooleanReadNode(Guid guid, string? SelectedOption, ServiceBundle? service = null, Point? position = null) : base(guid, position ?? new Point(0, 0))
        {
            AddPort(new LogicPort(PortGuids.Port_1, this, false));
            _service = service?.OSC;
            this.SelectedOption = string.IsNullOrEmpty(SelectedOption) ? string.Empty : SelectedOption;
