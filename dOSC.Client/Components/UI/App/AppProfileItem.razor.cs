...
public partial class AppProfileItem
{
    ...
    [Parameter] public EventCallback<AppLogic> AppChanged { get; set; }

    [Parameter] public EventCallback<AppLogic> OnShowSettings { get; set; }

    [Parameter] public EventCallback<AppLogic> OnPlayPause { get; set; }
    ...
    {
        if (App != null) OnShowSettings.InvokeAsync(App);
    }
