...
{
    public NumericNode(Guid? guid = null, ConcurrentDictionary<EntityPropertyEnum, dynamic>? properties = null,
        Point? position = null) : base(guid, position, properties)
    {
        Port = new NumericPort(PortGuids.Port_1, this, false, "Output");
        AddPort(Port);
