...
{
    public NotEqualNode(Guid? guid = null, ConcurrentDictionary<EntityPropertyEnum, dynamic>? properties = null,
        Point? position = null) : base(guid, position, properties)
    {
        AddPort(new MultiPort(PortGuids.Port_1, this, true, "Value A"));
        AddPort(new MultiPort(PortGuids.Port_2, this, true, "Value B"));
