...
{
    public NumericSwitchNode(Guid? guid = null, ConcurrentDictionary<EntityPropertyEnum, dynamic>? properties = null,
        Point? position = null) : base(guid, position, properties)
    {
        AddPort(new NumericPort(PortGuids.Port_1, this, true, "Switch"));
        AddPort(new MultiPort(PortGuids.Port_2, this, true, "Case 1"));
        AddPort(new MultiPort(PortGuids.Port_3, this, true, "Case 2"));
        AddPort(new MultiPort(PortGuids.PortGuidGenerator(1000), this, false, "Output"));
