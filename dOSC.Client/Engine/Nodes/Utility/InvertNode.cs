...
{
    public InvertNode(Guid? guid = null, ConcurrentDictionary<EntityPropertyEnum, dynamic>? properties = null,
        Point? position = null) : base(guid, position, properties)
    {
        AddPort(new MultiPort(PortGuids.Port_1, this, true,
            allowedTypes: new List<PortType> { PortType.Numeric, PortType.Logic, PortType.Multi }, name: "Value"));
